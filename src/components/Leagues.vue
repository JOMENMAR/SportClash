        ...
        >
          <div class="min-w-0">
            ...
            <p class="mt-0 text-sm leading-snug text-white/60">
              <template v-if="props.initialTab === 'public'">
                Explora ligas públicas globales. (Las privadas solo se ven en
                “Mis ligas”.)
              </template>
              <template v-else>
                Tus ligas (públicas y privadas) en un solo sitio.
              </template>
            </p>
          </div>
        ...
        <div v-if="tab === 'my'">
          ...
          >
            ...
            <div class="mt-1 text-sm text-white/60">
              Empieza creando una liga con tus colegas o explora las públicas.
            </div>
            <div class="mt-3 flex flex-col gap-2 sm:flex-row">
              ...
              <button
                type="button"
                class="w-full sm:w-auto rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold text-white ring-1 ring-white/10 hover:bg-white/15 transition"
                @click="tab = 'public'"
              >
                Ver Global
              </button>
